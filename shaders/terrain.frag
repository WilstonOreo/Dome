// JvB: slowed down camera movement which seems appropriate for this majestic shader
...
void main(void)
{
  ...
  float time = time*.15;
	...
	vec3 rd;
  if (fisheye_direction(gl_FragCoord.xy,resolution,time,time*0.2,time*0.1,rd) < 0.0)
  {
